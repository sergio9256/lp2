...
# INSTRUCTIONS for Running Chatbot nltk
# First make sure you have pip on your system
# pip3 --version
# If not present
...
pairs = [
    ...
    [
        r"what is your name ?",
        ["I am a bot created by Jaggu. you can call me crazy!", ]
    ],
    [
        r"how are you ?",
    ...
    [
        r"(.*) created ?",
        ["Jaggu created me using Python's NLTK library ", "top secret ;)", ]
    ],
    [
        r"(.*) (location|city) ?",
        ['Pune, Maharashtra', ]
...
def chat():
    print("Hi! I am a chatbot created by Jaggu for your service")
